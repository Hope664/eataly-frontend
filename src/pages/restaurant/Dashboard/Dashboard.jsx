          ...
          <div className="dash-banner">
            ...
            <div className="dash-banner__chart">
              ...
              <ResponsiveContainer width="100%" height={80}>
                <BarChart data={peakData} margin={{ top: 0, right: 0, bottom: 0, left: 0 }}>
          ...
          <div className="dash-middle">
            ...
            <div className="dash-card dash-revenue">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={revenueData[activeTab]} margin={{ top: 10, right: 10, bottom: 0, left: -20 }}>
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#F0F0F0" />
                  <XAxis dataKey="day" tick={{ fontSize: 11, fill: '#9CA3AF' }} axisLine={false} tickLine={false} />
                  <YAxis tick={{ fontSize: 11, fill: '#9CA3AF' }} axisLine={false} tickLine={false} />
                  <Tooltip
                    contentStyle={{ borderRadius: '8px', border: 'none', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
                    cursor={{ fill: 'rgba(42,122,75,0.05)' }}
                  />
                  <Bar dataKey="value" fill="#2A7A4B" radius={[6,6,0,0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
